...
const classesOfColumns =["col-sm-1 first-column", "col-sm-1", "col-sm-2","col-sm-2","col-sm-1","col-sm-2","col-sm-1","col-sm-2"];
                    ...
                    { classesOfColumns.map (
                        (name, index) => (
                            <th className={
                                ...
                                key={index + name}>
                                <input type="checkbox" defaultChecked={isChecked(index)} className='checkbox' aria-label="Checkbox for column" onClick={(e)=>{
